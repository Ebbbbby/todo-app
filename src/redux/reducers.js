...
const todoReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case REMOVE_TODO:
            return {
                todos: state.todos.filter((index) => index !== action.payload.id),
                filter: state.filter,
                searchTerm: state.searchTerm
            }
        ...
        case MARK_COMPLETED:
            return {
                todos: state.todos.map((index, todo) => index === action.payload.id ? { ...todo, completed: true } : todo),
                filter: state.filter,
                searchTerm: state.searchTerm
            }
        ...
        case MARK_INCOMPLETE:
            return {
                todos: state.todos.map((index, todo) => index === action.payload.id ? { ...todo, completed: false } : todo),
                filter: state.filter,
                searchTerm: state.searchTerm
            }
